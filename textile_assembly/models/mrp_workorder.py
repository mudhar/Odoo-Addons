...
class MrpWorkOrderQcLine(models.Model):
    ...
    show_button_input = fields.Boolean(string="Display Button Input", compute="_compute_button_input")

    @api.multi
    @api.depends('next_work_order_id', 'is_cutting', 'is_updated_from_prev_workorder')
    def _compute_button_input(self):
        for line in self:
            button_flag = False
            if not line.next_work_order_id:
                ...
                if not line.is_cutting and not line.is_updated_from_prev_workorder:
                    ...
                    button_flag = True
                elif line.is_cutting and not line.is_updated_from_prev_workorder:
                    button_flag = True
            line.show_button_input = button_flag
