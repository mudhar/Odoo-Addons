...
class MrpProduction(models.Model):
    ...
    #     if self.qty_produced != self.work_order_qty_produced:
    #         add_qty = self.work_order_qty_produced - self.qty_produced
    #         raise UserError(_("Quantity Yang Sudah Di Transfer Ke Gudang Sejumlah %s ."
    #                           "\n Tidak Berbanding Sama Dengan Quantity Jadi Sejumlah %s"
    #                           "\n Anda Harus Mentransfer Sejumlah %s Ke Gudang Untuk Produk %s") %
    #                         (self.qty_produced, self.work_order_qty_produced, add_qty, self.product_template_id.name))
    #     else:
    #         return True
